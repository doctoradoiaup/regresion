...
def train_and_evaluate(X_train, X_test, y_train, y_test):
    ...
    for name, model in models.items():
        ...
        y_proba = model.predict_proba(X_test)[:, 1]  # Probabilidades de renuncia
        ...
        results[name] = {
            ...
            "report": report,
            "model": model,
            "probabilities": y_proba  # Guardar las probabilidades
        }
...
def display_model_summary(results, X):
    ...
    for name, result in results.items():
        ...
        st.write("Probabilidades de Renuncia (1) para cada instancia:")
        ...
        elif name in ["Árbol de Decisión", "Bosque Aleatorio", "Gradient Boosted Tree"]:
            # Importancia de las características
...
if df is not None:
    ...
    X = df_dummies.drop(columns=["Renuncia_Si"])  # Ajustar según el nombre de tu columna
